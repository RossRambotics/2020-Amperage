...
public class Indexer extends SubsystemBase {
  ...
  public void reverseCompact() {
    //m_pidControllerBottom.setReference(m_dReverseCompactRotations, ControlType.kPosition);
    //m_pidControllerTop.setReference(m_dReverseCompactRotations, ControlType.kPosition);
